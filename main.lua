--[[
    ╔═══════════════════════════════════════════════════════════╗
    ║           APTX GUI LIBRARY - MODULAR FRAMEWORK            ║
    ║                      Version 2.0                          ║
    ╚═══════════════════════════════════════════════════════════╝
    
    Características:
    - Sistema modular de componentes
    - Carga remota via HttpGet
    - Colores ultra oscuros profesionales
    - DevMode para debugging
    - Sistema de secciones con íconos
    - Componentes: Button, Slider, Toggle, Menu, Input, Label
    
    Uso:
    local APTX = loadstring(game:HttpGet("url"))()
    APTX:Config("Mi GUI", true, false)
    
    Autor: APTX Framework
...
-- ════════════════════════════════════════════════════════════
-- LIBRERÍA DE ICONOS LUCIDE (IDs Verificados)
-- ════════════════════════════════════════════════════════════
local Icons = {
...
function APTX:CreateGUI()
    ...
    APTX.MainFrame.Size = UDim2.new(0, 580, 0, 380)
    APTX.MainFrame.Position = UDim2.new(0.5, -290, 0.5, -190)
...
function APTX:Slider(sectionName, text, icon, min, max, default, callback)
    ...
    -- Header con ícono, texto y valor
